# ltxq documentation index

The project overview (what it does, prerequisites, install, hosts.yaml setup,
run instructions) lives in the root [README.md](../README.md).
...
- [expansion-of-this-idea.md](expansion-of-this-idea.md) — expansion-ideas scratchpad (unimplemented ideas)
